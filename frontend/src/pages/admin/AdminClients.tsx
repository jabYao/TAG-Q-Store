...
export default function AdminClients() {
 ...
 className="max-w-xs px-3 py-2 bg-white border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-primary mb-4" />
 ...
 <td className="px-4 py-3 text-center"><span className="text-xs bg-gray-100 text-gray-600 px-2 py-0.5 ">{c.orders_count}</span></td>
 ...
 className="px-3 py-1.5 text-xs border border-gray-200 disabled:opacity-40">←</button>
