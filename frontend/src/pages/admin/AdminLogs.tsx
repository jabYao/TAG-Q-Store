      ...
      {logType === 'telescope' ? (
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-8 text-center">
          ...
          <p className="text-sm text-gray-400 mt-2 max-w-md mx-auto">
            Accedé a Telescope en <code className="text-primary bg-primary/5 px-1.5 py-0.5 rounded text-xs">/telescope</code> para ver requests, queries, logs, exceptions y más en tiempo real.
          </p>
          <a href="/telescope" target="_blank"
            className="inline-block mt-6 bg-primary text-white px-6 py-2.5 rounded-lg text-sm font-semibold hover:bg-primary-dark transition-colors">
            Abrir Telescope →
          </a>
        </div>
      ) : (
...
function ServerLogViewer() {
  ...
  return (
    <div>
      ...
      <div className="bg-carbon text-green-400 rounded-xl p-4 font-mono text-xs leading-relaxed h-[600px] overflow-y-auto">
