...
export default function AdminProducts() {
 ...
 <Link to="/admin/productos/nuevo" className="bg-primary text-white px-4 py-2 text-sm font-semibold hover:bg-primary-dark transition-colors inline-block">
 + Nuevo Producto
 </Link>
 </div>
 ...
 p.stock <= 0 ? 'text-red-500' : p.stock <= (p.min_stock ?? 5) ? 'text-amber-600' : 'text-green-600'
 }`}>
 {p.stock}
 </span>
 </td>
 ...
 disabled={page <= 1}
 className="px-3 py-1.5 text-xs border border-gray-200 disabled:opacity-40"
 >
 ← Anterior
 </button>
