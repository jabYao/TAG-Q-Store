...
export default function AdminImages() {
 ...
 {banners?.map((banner) => (
 <div key={banner.id} className="bg-white p-5 border border-gray-100 shadow-sm flex items-center gap-6">
 ...
 <span className={`inline-block mt-1 text-[10px] px-2 py-0.5 font-medium ${
 ...
 <a href="/admin/productos" className="mt-4 inline-block bg-primary text-white px-6 py-2.5 text-sm font-semibold hover:bg-primary-dark transition-colors">
 Ir a Productos
 </a>
 </div>
 )}
