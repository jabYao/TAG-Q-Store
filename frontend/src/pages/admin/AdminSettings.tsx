...
export default function AdminSettings() {
 ...
 return (
 <div key={setting.id} className="bg-white p-5 border border-gray-100 shadow-sm">
 ...
 className="mt-6 bg-primary text-white px-6 py-2.5 text-sm font-semibold hover:bg-primary-dark transition-colors disabled:opacity-50">
