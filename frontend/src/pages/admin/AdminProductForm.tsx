...
export default function AdminProductForm() {
 ...
 <span className="w-8 h-8 border-2 border-primary border-t-transparent animate-spin" />
 ...
 <div className="lg:col-span-2 bg-white p-5 border border-gray-100 shadow-sm">
 ...
 {gallery.map((img, i) => (
 <div key={img.id ?? `new-${i}`} className="group relative aspect-square bg-gray-100 flex items-center justify-center overflow-hidden">
 <img src={img.url} alt="" className="w-full h-full object-cover" />
 <span className="absolute top-1 left-1 w-5 h-5 bg-primary/80 text-white text-[10px] flex items-center justify-center font-bold">{i + 1}</span>
 ...
 className="absolute top-1 right-1 w-5 h-5 bg-red-500 text-white text-xs opacity-0 group-hover:opacity-100 transition-opacity">✕</button>
 </div>
 ))}
 </div>
 ) : (
 ...
 className="text-xs px-4 py-2 bg-primary text-white font-semibold hover:bg-primary-dark transition-colors disabled:opacity-50">
 ...
 className="w-full px-3 py-2 border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-primary" required />
 </div>
 <div>
 ...
 className="w-full px-3 py-2 border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-primary">
 ...
 className="w-full px-3 py-2 border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-primary" required min={0} />
 </div>
 <div>
 ...
 className="w-full px-3 py-2 border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-primary" min={0} placeholder="Para mostrar descuento" />
 </div>
 <div>
 ...
 className="w-full px-3 py-2 border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-primary" min={0} />
 </div>
 <div>
 ...
 <label key={val.id} className="flex items-center gap-2 px-3 py-1.5 hover:bg-gray-50 cursor-pointer text-sm text-carbon transition-colors">
 ...
 className="accent-primary w-4 h-4 border-gray-300"
 />
 )}
 {val.value}
 </label>
 ...
 className={`flex items-center gap-1.5 px-3 py-2 text-xs font-medium transition-all border ${
 isSelected
 ...
 >
 <span
 className="w-5 h-5 inline-block border border-gray-200 shrink-0"
 ...
 className="w-full px-3 py-2 border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-primary" maxLength={500} />
 </div>
 <div>
 ...
 placeholder="Clave"
 className="w-2/5 px-3 py-1.5 border border-gray-200 text-xs focus:outline-none focus:ring-1 focus:ring-primary" />
 ...
 placeholder="Valor"
 className="flex-1 px-3 py-1.5 border border-gray-200 text-xs focus:outline-none focus:ring-1 focus:ring-primary" />
 ...
 className="px-6 py-2.5 border border-gray-200 text-sm text-gray-600 hover:bg-gray-50 transition-colors">
 Cancelar
 </button>
 <button type="submit" disabled={saving}
 className="px-6 py-2.5 bg-primary text-white text-sm font-semibold hover:bg-primary-dark transition-colors disabled:opacity-50">
