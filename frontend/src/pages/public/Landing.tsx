...
export default function Landing() {
 ...
 <div className="absolute top-10 right-10 w-96 h-96 bg-gold/30 blur-3xl" />
 </div>
 ...
 <Link
 to="/catalogo"
 className="inline-block bg-gold text-carbon px-8 py-3.5 font-semibold text-sm hover:bg-[#e0c456] transition-all duration-200"
 >
 EXPLORAR COLECCIÓN →
 </Link>
 </div>
 ...
 <Link to="/contacto" className="inline-block bg-primary text-white px-8 py-3 text-sm font-semibold hover:bg-primary-dark transition-all">
 CONTACTANOS
 </Link>
 </section>
 </div>
