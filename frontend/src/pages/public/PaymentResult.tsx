...
export default function PaymentResult() {
 ...
 <span className={`text-xs font-semibold px-2.5 py-0.5 capitalize ${
 isApproved
 ...
 className="bg-primary text-white px-6 py-3 font-semibold text-sm hover:bg-primary-dark transition-colors"
 >
 Ver pedido
 </Link>
 )}
