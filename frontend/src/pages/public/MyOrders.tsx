...
export default function MyOrders() {
 ...
 className="block bg-white p-5 border border-gray-100 shadow-sm hover:shadow-md transition-all duration-200 hover:-translate-y-0.5">
 ...
 <span className={`inline-block mt-1 text-[10px] px-2 py-0.5 font-medium ${status.color}`}>
 {status.label}
 </span>
 </div>
 </div>
