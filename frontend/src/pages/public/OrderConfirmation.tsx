...
export default function OrderConfirmation() {
 ...
 {/* Order card */}
 <div className="bg-white border border-gray-200 p-6 text-left space-y-4 mb-8">
 ...
 <span className="text-xs font-semibold bg-amber-100 text-amber-800 px-2.5 py-0.5 capitalize">
 ...
 className="inline-flex items-center gap-2 bg-green-600 text-white px-8 py-3.5 font-semibold text-sm hover:bg-green-700 transition-all duration-200 mb-4"
 >
