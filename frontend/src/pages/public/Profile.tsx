...
export default function Profile() {
 ...
 className="flex items-center gap-3 px-4 py-3 text-sm text-gray-400 hover:bg-gray-100 transition-colors w-full text-left"
 >
 ...
 required
 className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-primary focus:bg-white transition-colors"
 />
 </div>
 <div>
 ...
 className="bg-primary text-white px-6 py-2.5 text-sm font-semibold hover:bg-primary-dark transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
 >
 ...
 disabled={updateMutation.isPending}
 className="px-6 py-2.5 text-sm text-gray-400 hover:text-carbon border border-gray-200 hover:border-gray-300 transition-colors disabled:opacity-50"
 >
 Cancelar
 </button>
 </div>
 ...
 className="bg-primary text-white px-5 py-2.5 text-sm font-semibold hover:bg-primary-dark transition-colors"
 >
 ✏️ Editar información
 </button>
 <button className="px-5 py-2.5 text-sm text-gray-500 border border-gray-200 hover:border-gray-300 transition-colors">
 🔑 Cambiar contraseña
 </button>
 </div>
 </>
...
function RecentOrders() {
 ...
 className="flex items-center justify-between p-3 hover:bg-gray-50 transition-colors border border-gray-100"
 >
