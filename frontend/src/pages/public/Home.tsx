...
import { IconTruck, IconCreditCard, IconReturn } from '@/components/ui/Icons'
...
export default function Home() {
 ...
 {/* Categories */}
 <section className="max-w-7xl mx-auto px-4 lg:px-6 pt-12 md:pt-16">
 <h2 className="text-[1.75rem] md:text-[3rem] text-carbon text-center mb-2 uppercase">
 ...
 <a
 href="/catalogo"
 className="inline-block bg-primary text-white px-8 py-3 font-semibold text-sm hover:bg-primary-dark transition-all duration-200"
 >
 ...
 className="w-24 h-24 bg-white shadow-sm border border-gray-100 flex items-center justify-center hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 shrink-0">
 {brand.logo_url ? (
 ...
 className="inline-block bg-primary text-white px-6 py-2 text-sm font-semibold hover:bg-primary-dark transition-colors"
 >
 ...
 <div className="p-4">
 <IconTruck size={32} className="mx-auto text-primary" />
 ...
 <div className="p-4">
 <IconCreditCard size={32} className="mx-auto text-primary" />
 ...
 <div className="p-4">
 <IconReturn size={32} className="mx-auto text-primary" />
