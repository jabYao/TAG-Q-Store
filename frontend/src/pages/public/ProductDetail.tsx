...
export default function ProductDetail() {
 ...
 <div
 className="aspect-square bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center border border-gray-100 mb-4 overflow-hidden cursor-crosshair relative"
 onMouseMove={(e) => {
 ...
 className={`w-16 h-16 md:w-20 md:h-20 border-2 flex items-center justify-center bg-gray-50 overflow-hidden transition-all ${
 i === selectedImage
 ? 'border-primary'
 ...
 <span className="text-xs font-bold text-carbon bg-gold px-2 py-0.5 ">-{discount}%</span>
 </>
 )}
 </div>
 ...
 {/* Shipping info */}
 <div className="bg-gray-50 p-4 text-sm text-gray-500 space-y-2">
