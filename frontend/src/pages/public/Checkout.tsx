...
export default function Checkout() {
 ...
 <div className="w-14 h-14 bg-gray-100 flex items-center justify-center overflow-hidden shrink-0">
 {item.image_url ? (
 ...
 className="mt-6 w-full bg-primary text-white py-3 font-semibold text-sm hover:bg-primary-dark transition-colors">
 CONTINUAR CON ENVÍO →
 </button>
 </div>
 )}
 ...
 {addresses.map((addr) => (
 <label key={addr.id} className={`block p-4 border-2 cursor-pointer transition-all ${
 ...
 <div className={`mt-0.5 w-4 h-4 border-2 flex items-center justify-center ${
 selectedAddressId === addr.id ? 'border-primary' : 'border-gray-300'
 }`}>
 {selectedAddressId === addr.id && <div className="w-2 h-2 bg-primary" />}
 </div>
 <div>
 ...
 className="flex-1 py-3 border border-gray-200 text-sm text-gray-600 hover:bg-gray-50 transition-colors">
 ← Volver
 </button>
 <button onClick={() => {
 ...
 className="flex-1 bg-primary text-white py-3 font-semibold text-sm hover:bg-primary-dark transition-colors">
 CONTINUAR AL PAGO →
 </button>
 </div>
 </div>
 ...
 {paymentMethod === 'wompi' && <div className="w-2.5 h-2.5 bg-primary" />}
 </div>
 <div>
 ...
 {paymentMethod === 'contraentrega' && <div className="w-2.5 h-2.5 bg-primary" />}
 </div>
 <div>
 ...
 <div className="flex-1 flex items-center justify-center gap-2 py-3.5 px-6 bg-gray-100 text-gray-400 text-sm">
 ...
 className="flex-1 bg-primary text-white py-3 font-semibold text-sm hover:bg-primary-dark transition-colors disabled:opacity-50"
 >
