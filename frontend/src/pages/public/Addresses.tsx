...
export default function Addresses() {
 ...
 <div className="bg-white p-6 border-2 border-primary shadow-sm mb-6 space-y-4">
 ...
 className="w-full px-3 py-2 border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-primary" placeholder="Ej: El Poblado, Chapinero, etc." />
 </div>
 <div>
 ...
 className="w-full px-3 py-2 border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-primary" placeholder="Ej: Cerca al parque" />
 </div>
 </div>
 ...
 className="px-6 py-2 border border-gray-200 text-sm text-gray-600 hover:bg-gray-50">Cancelar</button>
 </div>
 </div>
 )}
 ...
 {addresses?.map((addr) => (
 <div key={addr.id} className="bg-white p-5 border border-gray-100 shadow-sm flex items-start gap-4">
 ...
 {addr.is_default && <span className="text-[10px] bg-primary/10 text-primary px-2 py-0.5 font-medium">Predeterminada</span>}
 </div>
