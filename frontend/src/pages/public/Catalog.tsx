...
export default function Catalog() {
 ...
 className="px-3 py-2 bg-white border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all"
 >
 {sortOptions.map((opt) => (
 ...
 className={`px-3 py-2 text-sm font-medium border transition-all lg:hidden ${
 hasActiveFilters
 ...
 className="px-3 py-2 text-sm border border-gray-200 bg-white hover:bg-gray-50 disabled:opacity-40 disabled:cursor-not-allowed transition-all"
 >
 ← Anterior
 </button>
