...
export default function ColorsTab() {
 ...
 {isCreating && (
 <div className="bg-white p-4 border-2 border-primary shadow-sm flex flex-col gap-3">
 ...
 placeholder="#FF0000" className="flex-1 px-2 py-1.5 border border-gray-200 text-xs font-mono" />
 </div>
 ...
 className="flex-1 bg-primary text-white px-3 py-1.5 text-xs font-semibold hover:bg-primary-dark">Guardar</button>
 ...
 {colors?.map((color) => (
 editingId === color.id ? (
 <div key={color.id} className="bg-white p-4 border-2 border-primary shadow-sm flex flex-col gap-3">
 <div className="flex items-center gap-2">
 ...
 className="flex-1 bg-primary text-white px-3 py-1.5 text-xs font-semibold hover:bg-primary-dark">Actualizar</button>
 <button onClick={() => setEditingId(null)} className="text-xs text-gray-500 hover:text-gray-700">Cancelar</button>
 </div>
 </div>
 ) : (
 <div key={color.id}
 className="bg-white p-4 border border-gray-100 shadow-sm hover:border-gray-200 transition-colors group">
 <div className="flex flex-col items-center text-center gap-2">
 <span className="w-12 h-12 border-2 border-gray-200 shadow-sm"
