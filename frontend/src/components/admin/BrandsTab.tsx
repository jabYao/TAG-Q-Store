...
export default function BrandsTab() {
 ...
 className="w-20 h-20 mx-auto bg-gray-50 border-2 border-dashed border-gray-200 flex items-center justify-center cursor-pointer hover:border-gray-300 transition-colors overflow-hidden">
 {editForm.logo_url ? (
 ...
 {brands?.map((brand) => (
 editingId === brand.id ? (
 <div key={brand.id} className="bg-white p-5 border-2 border-primary shadow-sm flex flex-col gap-3">
 ...
 <div key={brand.id} className="bg-white p-5 border border-gray-100 shadow-sm flex items-center gap-4 hover:border-gray-200 transition-colors group">
 <div className="w-14 h-14 bg-gray-50 flex items-center justify-center text-xl shrink-0 overflow-hidden p-1"
