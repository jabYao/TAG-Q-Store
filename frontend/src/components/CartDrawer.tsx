                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-2">
                      <button
                        ...
                        className="w-7 h-7 rounded border border-gray-200 flex items-center justify-center text-sm text-carbon hover:bg-gray-50 transition-colors"
        ...
        {items.length > 0 && (
          <div className="border-t border-gray-200 px-5 py-4 shrink-0 space-y-3">
            ...
            <Link
              to="/checkout"
              onClick={onClose}
              className="block w-full bg-primary text-white text-center px-4 py-3 rounded-lg text-sm font-semibold hover:bg-primary-dark transition-colors"
            >
              FINALIZAR COMPRA →
            </Link>
            <Link
