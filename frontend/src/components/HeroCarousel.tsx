...
export default function HeroCarousel({ slides, interval = 5000 }: HeroCarouselProps) {
  ...
  return (
    <section className="relative bg-gradient-to-br from-black to-[#1a1a1a] text-white overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 lg:px-6 py-16 md:py-24 lg:py-[174px]">
        <div className="max-w-2xl transition-all duration-500">
          ...
          <a
            href={slide.ctaLink}
            className="inline-block bg-gold text-carbon px-8 py-3.5 rounded-lg font-semibold text-sm hover:bg-gold-light transition-all duration-200 shadow-lg hover:shadow-xl hover:-translate-y-0.5"
          >
            {slide.cta}
          </a>
        </div>
