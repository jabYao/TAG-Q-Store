...
export default function HeroBanner({ title, subtitle, cta, ctaLink, imageUrl }: HeroBannerProps) {
 ...
 <a
 href={ctaLink}
 className="inline-block bg-gold text-carbon px-8 py-3.5 font-semibold text-sm hover:bg-[#e0c456] transition-all duration-200 shadow-lg hover:shadow-xl hover:-translate-y-0.5"
 >
 {cta}
 </a>
 </div>
