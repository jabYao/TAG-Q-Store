...
export default function CatalogFilters(props: CatalogFiltersProps) {
 ...
 return (
 <li key={brand.id}>
 <label className={`flex items-center gap-2 px-3 py-1.5 cursor-pointer text-sm transition-colors ${
 ...
 className={`flex items-center gap-1.5 px-2.5 py-1.5 text-xs transition-all border ${
 isSelected
 ...
 >
 <span
 className="w-4 h-4 inline-block border border-gray-200 shrink-0"
 ...
 className="flex items-center gap-1 px-2.5 py-1.5 text-xs text-gray-400 hover:text-primary border border-dashed border-gray-300 hover:border-primary transition-all"
 >
 ...
 className="flex items-center gap-1 px-2.5 py-1.5 text-xs text-gray-400 hover:text-primary border border-dashed border-gray-300 hover:border-primary transition-all w-full justify-center mt-1"
 >
 ...
 <label className={`flex items-center gap-3 px-3 py-2 cursor-pointer text-sm transition-colors ${
